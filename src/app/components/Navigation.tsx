        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <Link
              ...
              className="hidden lg:inline-block floating-card rounded-full px-4 md:px-5 py-2 md:py-3 border border-[#D4AF37]/60 text-[#F5E6B8] text-[10px] md:text-xs tracking-[0.08em] hover:bg-[#D4AF37]/15 transition-all duration-300"
            >
              LIGHTENING FAST
            </Link>
            <Link
