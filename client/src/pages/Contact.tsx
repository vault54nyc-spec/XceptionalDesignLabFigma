        ...
        <section className="py-24 px-4 bg-black text-white">
          <div className="container max-w-6xl">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl leading-relaxed">
              ...
              Schedule a consultation to discuss how we can bring Chief of
              Staff-level governance and creativity to your organization.
            </p>
          </div>
        </section>
              ...
              <div className="space-y-12">
                <div>
                  ...
                  <p className="text-lg text-gray-600 mb-8">
                    Whether you need a strategic partner for a specific project
                    or ongoing operational support, we're here to help you
                    scale.
                  </p>
                ...
                <Card className="bg-black text-white border-0 shadow-xl">
                  <CardContent className="p-8">
                    ...
                    <p className="text-gray-300 mb-6">
                      Direct access to our principal consultants. 30-minute
                      introductory session to assess your needs and fit.
                    </p>
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <option value="Strategic Operations">
                        Strategic Operations
                      </option>
                      <option value="Design & Brand">Design & Brand</option>
                      <option value="Communications">Communications</option>
                      <option value="Technical Architecture">
