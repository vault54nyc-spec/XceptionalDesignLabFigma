...
const PORTFOLIO_ITEMS = [
  {
    ...
    description:
      "Comprehensive value realization framework for FY26 planning cycles.",
  ...
  },
  {
    ...
    description:
      "Modern logo design and visual identity system for community organization.",
  ...
  },
  {
    ...
    description:
      "Streamlined visual guide for complex internal reimbursement procedures.",
  ...
  },
  {
    ...
    description:
      "Event campaign materials driving community engagement and volunteerism.",
  ...
  },
  {
    ...
    description:
      "Vibrant, high-energy logo design for entertainment event series.",
  ...
  },
  {
    ...
    description:
      "Data-rich annual report highlighting fundraising metrics and outcomes.",
  ...
  },
  {
    ...
    description:
      "UX-focused intake form design to streamline content requests.",
        ...
        <section className="py-24 px-4 bg-black text-white">
          <div className="container max-w-6xl">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl leading-relaxed">
              A curated collection of strategic communications, brand identity,
              and digital experiences. Bridging the gap between executive
          ...
          <div className="container max-w-6xl">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredItems.map(item => (
                <Card
                  key={item.id}
                  className="group overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-gray-50"
                >
                    ...
                    <div className="flex justify-between items-start mb-3">
                      ...
                      {item.isPrivate && (
                        <div
                          ...
                          title="Sensitive details redacted"
                        >
        ...
        <section className="py-24 px-4 bg-gray-50 text-center">
          <div className="container max-w-4xl">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Whether it's a full brand overhaul or a critical executive
              presentation, we bring the same level of precision to every
              project.
            </p>
            <Button
              size="lg"
